...
const std::vector<float> BIOData::planeVertices = {
    //positions           //texture Coords
...
const std::vector<float> BIOData::vegetationVertices = {
...
const std::vector<float> BIOData::windowVertices = {
    //positions         //texture Coords (swapped y coordinates because texture is flipped upside down)
...
const std::vector<float> BIOData::cubeWithNormalVertices = {
    //positions         //normal
...
const BIOParm BIOData::cubeParm = {true,true,false,false};
const BIOParm BIOData::planeParm = {true,true,false,false};
const BIOParm BIOData::vegetationParm = {true,true,false,false};
const BIOParm BIOData::windowParm = {true,true,false,false};
const BIOParm BIOData::cubeWithNormalParm = {false,false,true,false};
//---------------------------------------------------------------
//public
//---------------------------------------------------------------
...
OVec_t BIOData::objVectices =
{
    ...
    {BIOType::OBJ_CUBE_WITH_NORMAL,BIOData::cubeWithNormalVertices}
};

OParm_t BIOData::objParameters = {
    {BIOType::OBJ_CUBE, BIOData::cubeParm},
    {BIOType::OBJ_PLANE, BIOData::planeParm},
    {BIOType::OBJ_VEGETATION, BIOData::vegetationParm},
    {BIOType::OBJ_WINDOW, BIOData::windowParm},
    {BIOType::OBJ_CUBE_WITH_NORMAL,BIOData::cubeWithNormalParm}
};
